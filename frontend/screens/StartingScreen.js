...
export default function StartingScreen() {
  return (
    <View className = 'flex-1'>
      ...
      <Text className='text-center text-6xl font-medium text-white mt-32'> L U N A L O G</Text>
      <Text className='text-center text-xl text-white mt-4 tracking-widest'> grow brighter like the moon </Text>
      
      {/* buttons */}
      
      <View className='items-center'>
        <TouchableOpacity className='mt-20 bg-white h-16 w-96 justify-center rounded-3xl'>
