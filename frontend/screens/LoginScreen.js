...
export default function LoginScreen() {
    ...
    return (
        ...
        <View className='items-center'>
            ...
            <Text className='pb-16 text-center font-medium text-3xl text-custom-darker-blue mt-8 tracking-widest'>password</Text>
            </TouchableOpacity>
        </View>

        <View className='items-center'>
            <TouchableOpacity className='outline-solid outline-white mt-8 opacity-0% h-16 w-96 justify-center rounded-3xl '>
